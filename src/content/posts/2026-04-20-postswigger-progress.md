...
Live tracker for my pass through the [PortSwigger Web Security Academy](https://portswigger.net/web-security). Topic ordering follows PortSwigger's own [all topics](https://portswigger.net/web-security/all-topics) recommendation, and the reasoning behind that choice is in [Episode #2](/posts/picking-a-path-through-portswigger-labs/).
...
If you're new to web security it's hard to know where to begin, so I've grouped every topic into three tracks — server-side, client-side, and advanced — and work through them in that order, completing the labs as I go. The grouping and ordering follow PortSwigger's own [all topics](https://portswigger.net/web-security/all-topics) page. For more guided support, their [learning paths](https://portswigger.net/web-security/learning-paths) are a good companion.
...
*Last updated: 2026-04-20. Topic grouping and ordering follow PortSwigger's [all topics](https://portswigger.net/web-security/all-topics) page.*
